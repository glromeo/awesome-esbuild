...
- [esbuild-babel-plugin](https://github.com/glromeo/esbuild-babel-plugin/): Tiny plugin to apply babel transformations on load....keep it simple, it's faster than you think.
